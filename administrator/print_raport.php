...
?>
<title>Laporan Raport Siswa</title>
...
<?php
  ...
  $g = mysql_fetch_array(mysql_query("SELECT * FROM tbl_siswa where nipd='$_GET[nipd]'"));
    if ($_GET['semester'] % 2 == 1){
      $ket = 'GANJIL';
    }else{
      $ket = 'GENAP';
    }

	echo "<br><center><b>RAPORT SEMESTER $ket TAHUN PELAJARAN $_GET[tahun]</b></center><br>";

echo "<table>
        <tr><td></td> <td></td><td rowspan='5'><img style='width:75px; margin-left:5px' src='../siswa/foto_siswa/$g[foto]'></td></tr>

        <tr><td style='background:#f4f4f4; border-bottom:1px solid #8a8a8a' width=120px><b>No Induk</b></td> <td style='border-bottom:1px solid #8a8a8a'> : $g[nipd]</td></tr>

        <tr><td style='background:#f4f4f4; border-bottom:1px solid #8a8a8a'><b>Nama Lengkap</b></td>    <td style='border-bottom:1px solid #8a8a8a'> : $g[nama_siswa]</td></tr>

        <tr><td style='background:#f4f4f4; border-bottom:1px solid #8a8a8a'><b>Nama Kelas</b></td>    <td style='border-bottom:1px solid #8a8a8a'> : $g[nama_kelas]</td></tr>

        <tr><td style='background:#f4f4f4; border-bottom:1px solid #8a8a8a'><b>Semester</b></td>    <td style='border-bottom:1px solid #8a8a8a'> : $_GET[semester]</td></tr>
        
        <tr><td style='background:#f4f4f4; border-bottom:1px solid #8a8a8a'><b>Tahun Pelajaran</b></td>    <td style='border-bottom:1px solid #8a8a8a'> : $_GET[tahun]</td></tr>
      </table><br>";
  ...
  $tampil = mysql_query("SELECT * FROM tbl_nilai a JOIN tbl_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                            where a.nipd='$_GET[nipd]' AND a.semester='$_GET[semester]' AND a.tahun_ajaran='$_GET[tahun]'");
  $no = 1;
    ...
    $totalnilai  = number_format($akhir,1);
