<?php
	...
	$rombel_saat_ini = $_POST['rombel_saat_ini'];
	...
	if ($filename != ''){
		if (move_uploaded_file($_FILES['foto']['tmp_name'], $uploadfile))
		{
			mysql_query("UPDATE tbl_siswa SET id_siswa='$id_siswa', nama_siswa='$nama_siswa', nipd='$nipd', jenis_kelamin='$jenis_kelamin', nisn='$nisn', tempat_lahir='$tempat_lahir', 
				...
				alat_transportasi='$alat_transportasi', telepon='$telepon', hp='$hp', email='$email', kode_kelas='$kode_kelas', skhun='$skhun', penerima_kps='$penerima_kps', 
				...
				pendidikan_wali='$pendidikan_wali', pekerjaan_wali='$pekerjaan_wali', penghasilan_wali='$penghasilan_wali', nik_wali='$nik_wali', 
				rombel_saat_ini='$rombel_saat_ini', no_peserta_un='$no_peserta_un', no_ijazah='$no_ijazah', penerima_kip='penerima_kip', 
